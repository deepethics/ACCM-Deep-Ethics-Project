...
The project’s longer stand-up-style “allegedly” exchange is preserved on the [Humor / Funnymism page]({{ '/HUMOR/' | relative_url }}). The inserted word works like a wink: it does not prove the official claim false. It removes the costume of automatic certainty and returns the claim to inspection.
