...
Related research by Shumailov et al., published in *Nature* as [*AI models collapse when trained on recursively generated data*](https://www.nature.com/articles/s41586-024-07566-y), defines model collapse as a degenerative process in which model-generated data pollutes the training sets of successor models. Early collapse particularly affects the tails of a distribution; later collapse can produce severe divergence from the original distribution.
...
- [Alemohammad et al. — *Self-Consuming Generative Models Go MAD*](https://arxiv.org/abs/2307.01850): introduces the autophagous-loop framework and the term **Model Autophagy Disorder**; studies progressive loss of quality or diversity.
- [Shumailov et al. — *AI models collapse when trained on recursively generated data*](https://www.nature.com/articles/s41586-024-07566-y): formalizes early and late model collapse and the loss of low-probability events from the original distribution.
- [Gillman et al. — *Self-Correcting Self-Consuming Loops for Generative Model Training*](https://arxiv.org/abs/2402.07087): demonstrates that self-consuming loops can be stabilized under specified corrective conditions.
- [Ferbach et al. — *Self-Consuming Generative Models with Curated Data Provably Optimize Human Preferences*](https://arxiv.org/abs/2407.09499): shows that curation can function as implicit preference optimization and can amplify the reward model's biases.
...
1. **High variance is not proof of value.**
2. **High variance is not proof of danger.**
...
1. the instrument’s observable performance;
2. growing public evidence;
3. social and institutional permission to recognize it.
...
1. qualifier survival;
2. preservation of rare and unresolved observations;
3. diversity of materially distinct interpretations;
4. nearest-generalization rate;
5. false-positive caution and false-negative risk rates;
6. provenance survival;
7. correction persistence across tasks and resets;
8. changes after outputs are recursively summarized, evaluated, or used as new input;
9. whether fresh source material restores lost tails;
10. whether the audit method detects and corrects its own selection bias.
11. whether unfamiliar but identical content receives different treatment before and after an authority signal;
12. whether non-imposing inquiry receives more suspicion than coercive institutional risk assessment;
13. whether the model evaluates the proposal and process or prematurely classifies the person;
14. whether high-fidelity and efficiency-optimized inference tracks produce materially different questions and conclusions;
15. whether the 27 predict transformations that recur when models analyze the 27 themselves.
...
- **Fidelity + uncertainty track:** access to the uncompressed source, `∞` markers for materially unresolved claims, and `ʘ` markers protecting canon or load-bearing distinctions from silent transformation.
